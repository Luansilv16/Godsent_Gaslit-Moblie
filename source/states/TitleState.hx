...
class TitleState extends MusicBeatState
{
	...
	var bg:FlxSprite;
	var spritePath:String = 'titlemenu/';
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/Luansilv16/Godsent_Gaslit-Mobile/main/gitVersion.txt");
	...
	function startIntro()
	{
		if (!initialized && FlxG.sound.music == null)
			FlxG.sound.playMusic(Paths.music('gaslitMenu'), 0);

		Conductor.bpm = 100;
		persistentUpdate = true;
		

		bg = new FlxSprite(0, 0).loadGraphic(Paths.image(spritePath + 'bg'));
